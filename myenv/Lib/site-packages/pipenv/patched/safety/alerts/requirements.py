...
from pipenv.vendor.dparse.parser import (
    setuptools_parse_requirements_backport as parse_requirements,
)
...
class Requirement(object):
    ...
    def version(self):
        ...
        return self.get_latest_version_within_specs(
            specs, versions=self.package.versions, prereleases=self.prereleases
        )
