...
class Project:
    ...
    def get_outdated_packages(self) -> list[importlib_metadata.Distribution]:
        return self.environment.get_outdated_packages(
            pre=self.pipfile.get("pre", False)
        )
    ...
    def create_pipfile(self, python=None):
        ...
        for i, index in enumerate(indexes):
            ...
            sources.append(
                {"url": index, "verify_ssl": verify_ssl, "name": source_name}
            )
        ...
        version = (
            python_version(required_python) or self.s.PIPENV_DEFAULT_PYTHON_VERSION
        )
        if version:
